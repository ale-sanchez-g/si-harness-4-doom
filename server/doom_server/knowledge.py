...
MONSTERS: dict[str, MonsterInfo] = {
    ...
    "ChaingunGuy": MonsterInfo(3, "hitscan", "chaingun zombie, fires fast"),
    "WolfensteinSS": MonsterInfo(2, "hitscan", "SS soldier with a machine gun"),
    "DoomImp": MonsterInfo(2, "projectile", "imp, throws fireballs"),
    "Demon": MonsterInfo(2, "melee", "fast biting demon, melee only"),
    "Spectre": MonsterInfo(2, "melee", "nearly invisible biting demon, melee only"),
    ...
    "BaronOfHell": MonsterInfo(4, "projectile", "very tough, throws green fireballs"),
    "Arachnotron": MonsterInfo(3, "projectile", "spider robot with a plasma gun"),
    "PainElemental": MonsterInfo(3, "summoner", "spits flying skulls"),
    "Revenant": MonsterInfo(3, "projectile", "skeleton with homing rockets"),
    "Fatso": MonsterInfo(4, "projectile", "mancubus, fires volleys of fireballs"),
    "Archvile": MonsterInfo(5, "hitscan", "revives dead monsters and burns you, most dangerous"),
    "Cyberdemon": MonsterInfo(5, "projectile", "boss with rockets, extremely tough"),
    ...
    "MarineChainsawVzd": MonsterInfo(2, "melee", "chainsaw marine, melee only"),
}
